...
> = {
  ...
  projects: {
    en: {
      title: "Projects",
      description:
        "Selected website work for modern businesses: portfolio, landing pages, restaurants, and fitness brands built for clarity, trust, and conversion.",
    },
    sv: {
      title: "Projekt",
      description:
        "Utvalda webbprojekt för moderna företag: portfolio, landningssidor, restauranger och fitnessvarumärken byggda för tydlighet, förtroende och konvertering.",
    },
  },
  process: {
    en: {

  ...
  return (
    <LanguageProvider locale={locale}>
      <div className="relative min-h-screen overflow-x-hidden">
        <a
          href="#main-content"
          className="sr-only z-[60] rounded-md bg-accent px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-slate-950 focus:not-sr-only focus:fixed focus:left-4 focus:top-4"
        >
          {skipLabel}
        </a>
